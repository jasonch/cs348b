...
#ifndef PBRT_MATERIALS_CHARCOAL_H
#define PBRT_MATERIALS_CHARCOAL_H
...
class CharcoalMaterial : public Material {
public:
    // MatteMaterial Public Methods
    CharcoalMaterial(Reference<Texture<Spectrum> > kd,
...
CharcoalMaterial *CreateCharcoalMaterial(const Transform &xform,
